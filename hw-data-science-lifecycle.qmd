...
The fucntion mutate lets you convert some kind of data into a specific kind of data, like a conversion. At the first part the fuction is converting the waste per year to a capita of waste in KG per year per person. the second part of the function mutate is classifying the data sets into 4 levels, HIC been the highest, UMC the second highest, LMC the second lowest and LIC been the lowest.
...
In fact, mutate permits to classify and convert data, like doing mathematical operations like sum and dividing. And classifying groups of data like HIC, UMC, LMC and LIC

5.  Describe in your own words what the 'color' argument inside the `aes()` does

Sets an specific type of color to the different classifications of income_id

6.  Describe in your own words what the `labs()` function does

it lets you modify the axes labels and put all kind of titles in there.
